...
<body>
    ...
    <div id="controle-footer">
        <section>
            ...
            <div id="entrada">
                <form method="post" action="buscaRegiaoServlet" onsubmit="return buscarItinerarios();">
                    <input type="text" id="busca" placeholder="Buscar por região" name="tregiao" required/>
                    <button>OK</button>
                </form>
            </div>
    ...
    <script src="./script/itinerarios.js"></script>
